...
* The original package name 'kempaiah.microservices.spring-boot-rest-api' is invalid and this project uses 'kempaiah.microservices.springbootrestapi' instead.
